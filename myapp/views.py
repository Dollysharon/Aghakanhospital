...
from hospital.credentials import LipanaMpesaPpassword, MpesaAccessToken
...
def contact_view(request):
    if request.method == "POST":
        mycontact = Contact(  # This refers to the model, not the view
...
def edit(request, id):
    ...
    if request.method == "POST":
        ...
        return redirect('show')  # ✅ Redirect instead of rendering 'show'
    else:
